...
## 14. MLOps 학습 워커 설치 패키지 (Phase 3 마무리) — **반영 대기**
...
## 15. train_dfine.py 학습 곡선·에폭별 지표 아티팩트 — **반영 대기**
...
## 16. MLOps 연동 비활성 사유 표시 (헤더 칩 · 이미지 저장 설정 힌트) — **반영 대기**
...
## 17. MLOps 수집 사진은 오버레이 전 원본으로 전송 — **반영 대기**
...
## 18. Web 연동 계약 결함 3건 (API 키·결과 폐기·이미지 평문) — **반영 대기**
...
## 19. Web 연동 정합성 마무리 (검사 시각·종료 통지·이미지 큐·지표) — **반영 대기**
