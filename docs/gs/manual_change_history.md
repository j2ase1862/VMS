...
## 14. MLOps 학습 워커 설치 패키지 (Phase 3 마무리) — **반영 완료 (2026-09-14, 별책 §2 '웹에서 학습하기')** · ⏳ 스크린샷 2장(워커 설치 마법사·관리 화면 워커 카드) 잔여
...
## 16. MLOps 연동 비활성 사유 표시 (헤더 칩 · 이미지 저장 설정 힌트) — **반영 완료 (2026-09-14, 본편 §4.2.10 신설 + §4.3 카드 + 마법사 표)** · ⏳ 헤더 칩 그림 1장 잔여(재현 필요)
...
## 19. Web 연동 정합성 마무리 (검사 시각·종료 통지·이미지 큐·지표) — **반영 완료 (2026-09-14, 본편 §7.6·§8.3·§8.5·§9.4·§10.1·§11.4)** · ⏳ WO 재배정 경고 그림 1장 잔여(현장 재현 필요)
