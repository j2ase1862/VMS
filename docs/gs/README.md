...
| PR | 매뉴얼에 들어갈 내용 | 대상 절 |
|----|--------------------|--------|
| (반영 완료 2026-09-10, 문구) #452 | **AI 학습 도구 기본 제외** — 설치 구성 선택 화면 "AI 학습 도구 포함" 기본 해제(라벨링·학습은 MLOps 가 기본, 서버 없는 PC 만 체크), 업그레이드는 이전 선택 유지. 본편 §6 안내·§11.4·별책 안내 반영. ⚠ 잔여: `71_msi_weboption.png` 재캡처(체크 해제 상태 + 문구 "기본 해제") | §2.1 §6 §11.4 별책 |
