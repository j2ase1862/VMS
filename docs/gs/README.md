...
| #417 | **단독 모드에서도 Recent Inspections(최근 검사) 패널에 기록** — NG 코드 자리에 실패 도구 이름, 레시피 이름은 로컬 레시피명, 도움말 문구 갱신. 상세: manual_change_history.md §3 | §3.5 단독 모드 (+§4 Recent Inspections·§11.4 이력) |
