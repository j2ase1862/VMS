...
| #356 | **헤더 Lot 콤보 상시 노출** — **✅ 본문 반영 완료 (2026-08-21, §4.11 Lot 사용법 신설 + §5.2 표 + §8.4)**. 잔여: 멀티 Lot 콤보 스크린샷(FHD 기준) + docx 재생성 | §4.11(Lots), §5.2(추적성) |
| Web #83 | **작업지시 페이지 실시간 갱신** — **✅ 본문 반영 완료 (2026-08-21, §4.7 실시간 항목 + §5.4)**. 잔여: docx 재생성 | §4.7(Work Orders), §5.4(실시간) |
| Web #82+#84 | **생산 이력 하루치 조회 정상화** (같은 날짜 선택·요약 카드·UTC 9시간·Excel 로컬 시각) — **✅ 본문 반영 완료 (2026-08-21, §4.6 + §8.4)**. 잔여: 날짜 피커 2개 스크린샷 + docx 재생성 | §4.6(Production History) |
| Web #85 | **생산 이력 WO/LOT 필터** — **✅ 본문 반영 완료 (2026-08-21, §4.6)**. 잔여: 필터 바 스크린샷 + docx 재생성 | §4.6(Production History) |
