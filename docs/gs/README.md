...
| (머지 후 #) | **AppSetup 3단계 〈Area Scan〉 Exposure/Gain 입력란 제거** — 런타임 미사용 설정 정리, 안내 문구로 대체. 입력 항목 표 행 삭제 + 3단계 풀페이지 재캡처. 상세: manual_change_history.md §1 | §3.2 (+§5.3 상호 참조·§11.4 이력) |
