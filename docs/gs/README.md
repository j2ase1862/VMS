...
| PR | 매뉴얼에 들어갈 내용 | 대상 절 |
|----|--------------------|--------|
| #364 | **안내 창 다크 디자인 통일** — VMS·VisionSetup·AppSetup 의 모든 메시지/확인 창이 다크 디자인으로 변경 (동작 동일). 매뉴얼 내 안내 창 언급 스크린샷이 있다면 재캡처 대상. Phase B(DeepLearning/Updater) 는 미적용 | 전반 (스크린샷 위주) |
