...
> - 코드 서명은 [gs_msi_code_signing_guide.md](gs_msi_code_signing_guide.md) (미적용 상태)
...
- Authenticode 인증서를 적용하면 경고가 사라지고 사용자 신뢰도가 올라감 — 별도 가이드: [gs_msi_code_signing_guide.md](gs_msi_code_signing_guide.md).
...
- 코드 사이닝 인증서 적용 (`gs_msi_code_signing_guide.md` 참고)
